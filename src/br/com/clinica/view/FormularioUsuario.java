...
public class FormularioUsuario extends JFrame {
	JComboBox<Object> cboUserUsuario = new JComboBox<Object>();
	/**
	 * 
	 */
	...
	public FormularioUsuario() {
		setIconImage(Toolkit.getDefaultToolkit()
				.getImage(FormularioUsuario.class.getResource("/br/com/clinica/image/hospital.png")));
		...
		btnnovouser.setIcon(new ImageIcon(FormularioUsuario.class.getResource("/br/com/clinica/image/new.png")));
		...
		btnsaveuser.setIcon(new ImageIcon(FormularioUsuario.class.getResource("/br/com/clinica/image/save2.png")));
		...
		btnatualizauser.setIcon(new ImageIcon(FormularioUsuario.class.getResource("/br/com/clinica/image/uptade.png")));
		...
		dskusuario.setBorder(
				new TitledBorder(null, "CadastroUsuario", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		cboUserUsuario.setModel(new DefaultComboBoxModel<Object>(new String[] { "ADM", "USER" }));
	...
	private boolean fieldsValidationUser() {
		return txtnomeuser.getText().isEmpty() || (txtcpfuser.getText().isEmpty() || (txtprofisao.getText().isEmpty()))
				|| (txtloginuser.getText().isEmpty() || (txtsenhauser.getText().isEmpty()));
	}
	...
	// setando campos dpois de pesquisar cpf
	private void setUsuario(Usuario usuario) {
		txtnomeuser.setText(usuario.getNomeUsuario());
		txtcpfuser.setText(usuario.getCpfUsuario());
		txtprofisao.setText(usuario.getCpfUsuario());
		txtloginuser.setText(usuario.getLoginUsuario());
		txtsenhauser.setText(usuario.getSenhaUsuario());
	}

	// metodo de uptade
	private Usuario UptadeUser() {
		Usuario usuario = new Usuario();
		usuario.setNomeUsuario(txtnomeuser.getText());
		usuario.setTipoUsuario(cboUserUsuario.getSelectedItem().toString());
		usuario.setCpfUsuario(txtcpfuser.getText());

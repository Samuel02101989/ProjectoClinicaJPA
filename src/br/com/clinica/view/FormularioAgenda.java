...
public class FormularioAgenda extends JFrame {
	...
	JComboBox<Object> cboStress = new JComboBox<Object>();
	...
	public FormularioAgenda() {
		setIconImage(Toolkit.getDefaultToolkit()
				.getImage(FormularioAgenda.class.getResource("/br/com/clinica/image/icon.png")));
		...
		try {
			...
			txtFichaNome = new javax.swing.JFormattedTextField(format_textField4);
		} catch (Exception e1) {
			e1.printStackTrace();
		}
		...
		btnfichanome.setIcon(new ImageIcon(FormularioAgenda.class.getResource("/br/com/clinica/image/procurar.png")));
		...
		try {
			javax.swing.text.MaskFormatter format_textField4 = new javax.swing.text.MaskFormatter("##/##/####");
			txtDataNascAgenda = new javax.swing.JFormattedTextField(format_textField4);
		} catch (Exception e1) {
			e1.printStackTrace();
		}
		...
		btnpesquisarmedico
				.setIcon(new ImageIcon(FormularioAgenda.class.getResource("/br/com/clinica/image/procurar.png")));
		...
		try {
			javax.swing.text.MaskFormatter format_textField4 = new javax.swing.text.MaskFormatter("###.###.###-##");
			txtCpfMedicoAgenda = new javax.swing.JFormattedTextField(format_textField4);
		} catch (Exception e1) {
			e1.printStackTrace();
		}
		...
		btnAgendarconsulta.setIcon(
				new ImageIcon(FormularioAgenda.class.getResource("/br/com/clinica/image/if_f-check_256_282474.png")));
	...
	private void saveConsultaDba(FichaMedica agenda) {
